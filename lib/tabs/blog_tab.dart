...
import 'package:marcustan/config/constants.dart';
import 'package:marcustan/models/blog_model.dart';
import 'package:marcustan/providers/api_provider.dart';
import 'package:marcustan/widgets/blog_widget.dart';
import 'package:marcustan/widgets/responsive_widget.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              elevation: 0.0,
              onPressed: () =>
                  html.window.open(Constants.PROFILE_MEDIUM, 'marcustan'),
            )
          ],
        ),
      ),
